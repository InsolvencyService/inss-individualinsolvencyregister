...
namespace TestFramework.TestFramework.Features
{
...
#line hidden
        ...
        public virtual void TechUpliftTest1()
        {
            string[] tagsOfScenario = new string[] {
                    "Regression"};
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("TechUplift Test 1", null, new string[] {
                        "Regression"});
#line 6
