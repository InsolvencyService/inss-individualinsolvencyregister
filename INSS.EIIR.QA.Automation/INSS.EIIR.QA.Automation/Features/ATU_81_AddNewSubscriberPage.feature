...
Scenario: Verify the breadcrumb navigation on the Add subscriber page1
...
@AddSubscriberDetails @Regression
Scenario: Verify the Add subscriber details page URL, page title1
Then the Add New Subscriber page is displayed with the expected URL, page title and header

@AddSubscriberDetails @Regression
Scenario: Verify the error messages for the text entry fields on the add new subscriber page
...
@AddSubscriberDetails @Regression
Scenario: Verify the incorrect postcode format error message on the Add New Subscriber page
Given I first populate all of the fields on the Add new subscriber page
...
@AddSubscriberDetails @Regression
Scenario: Verify the error messages for Application submitted date on the Add New Subscriber page
Given I first populate all of the fields on the Add new subscriber page
...
@AddSubscriberDetails @Regression
Scenario: Add a new subscriber with between 1 and 3 data extract emails and verify the new subscriber details are reflected on the Subscriber Details page 
