...
Scenario: ATU_213 Verify the Subscriber details page URL, page title, header and the subscription ends in X days value
...
@SubscriberDetails @Regression
Scenario: ATU_213 Verify the Subscriber details page displays the correct details for a subscriber
...
@SubscriberDetails @Regression
Scenario: ATU_213 Click the Return to admin area button
When I click the Return to admin area button 
Then I am navigated to the Admin Dashboard page

@SubscriberDetails @Regression
Scenario: ATU_213 Click the View another subscriber link
When I click the View another subscriber link
Then I am navigated to the Admin Subscriber List page

@SubscriberDetails @Regression
Scenario: ATU_213 Verify the Subscribers breadcrumb navigation on the Subscriber details page
When I click the Subscribers breadcrumb on the Subscriber details page
Then I am navigated to the Admin Subscriber List page

@SubscriberDetails @Regression
Scenario: ATU_213 Verify the Home breadcrumb navigation on the Subscriber details page
