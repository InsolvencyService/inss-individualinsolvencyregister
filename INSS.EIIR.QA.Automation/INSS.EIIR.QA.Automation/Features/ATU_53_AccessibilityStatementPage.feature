Feature: Update Accessibility Statement page
...
Scenario: Verify the Accessibility statement page URL, title and page heading
Then the Accessibility statement page will be displayed and the URL, page title and H1 will be as per requirements

@AccessibilityStatement @Regression
Scenario: Verify the navigation of the Home breadcrumb on the Accessibility statement page
...
@AccessibilityStatement @Regression
Scenario: Verify the navigation of the 'how to make your device easier to use' link
...
@AccessibilityStatement @Regression
Scenario: Verify the navigation of the 'general enquiry form' link
...
@AccessibilityStatement @Regression
Scenario: Verify the navigation of the 'Find out about call charges' link
...
@AccessibilityStatement @Regression
Scenario: Verify the navigation of the 'contact the Equality Advisory and Support Service (EASS)' link
...
@AccessibilityStatement @Regression
Scenario: Verify the navigation of the 'The Public Sector Bodies (Websites and Mobile Applications) (No. 2) Accessibility Regulations 2018' link
...
@AccessibilityStatement @Regression
Scenario: Verify the navigation of the 'Web Content Accessibility Guidelines (WCAG) version 2.1' link
