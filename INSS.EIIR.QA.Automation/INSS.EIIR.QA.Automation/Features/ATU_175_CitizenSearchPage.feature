Feature: Citizen - Search via single search box
	As a user
...
Scenario: Verify the Citizen Search page
Then the URL, page title and page heading will be as per the requirements

@CitizenSearchPage @Regression
Scenario: Verify error message when pressing search without entering a search term
