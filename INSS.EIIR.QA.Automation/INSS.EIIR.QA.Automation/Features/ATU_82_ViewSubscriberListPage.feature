...
@SubscriberList
Scenario: ATU_82 Subscriber table is sorted correctly when active Subscribers are displayed
Then the table is sorted by subscription end date and displays "Active subscribers" only

@SubscriberList
Scenario: ATU_82 Subscriber table is sorted correctly when inactive Subscribers are displayed
...
@SubscriberList
Scenario: ATU_82 Subscriber table is sorted correctly when all subscribers are displayed
...
@SubscriberList
Scenario: ATU_82 Verify the Home breadcrumb takes the user back to the Admin dahsboard
