...
@Admin @Regression
Scenario: Verify the Admin login page header, URL and page title
Then I am navigated Admin Login page

@Admin @Regression
Scenario: Click the Sign in button without entering a Username
When I enter a password only and press the Sign in button
Then I am shown the enter username error message 

@Admin @Regression
Scenario: Click the Sign in button without entering a password
When I enter a username only and press the Sign in button
Then I am shown the enter password error message 

@Admin @Regression
Scenario: Click the Sign in button without entering a Username or password
...
@Admin @Regression
Scenario: Click the Sign in button after entering an invalid Username and password
