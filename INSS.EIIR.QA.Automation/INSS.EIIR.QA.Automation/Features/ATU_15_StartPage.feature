Feature: ATU_15 Citizen - Start Page
	As a user
...
Scenario: ATU_15 Verify the EIIR start page URL, title and page heading
Then the EIIR Start page will be displayed and the URL, page title and H1 will be as per requirements

@StartPage @Regression
Scenario: ATU_15 Verify the 'Start now' button takes the user to the Search screen
When I click the 'Start now' button
Then I am taken to the Search page

@StartPage @Regression
Scenario: ATU_15 Verify the navigation of the Terms and conditions footer link on the EIIR start page
...
@StartPage @Regression
Scenario: ATU_15 Verify the navigation of the Privacy footer link on the EIIR start page
...
@StartPage @Regression
Scenario: ATU_15 Verify the navigation of the Accessibility Statement footer link on the EIIR start page
...
@StartPage @Regression
Scenario: ATU_15 Verify the navigation of the Terms and conditions hyperlink on the EIIR start page
When I click the "main content Terms and conditions" link
Then the following URL is displayed "https://app-uksouth-sit-eiir-web.azurewebsites.net/home/terms-and-conditions"

@StartPage @Regression
Scenario: ATU_15 Verify the navigation of the Insolvency Service hyperlink on the EIIR start page
...
@StartPage @Regression
Scenario: ATU_15 Verify the (Get help from the Insolvency Service) link in the Related content section on the EIIR start page
...
@StartPage @Regression
Scenario: ATU_15 Verify the (Find out more about bankruptcy and insolvency) link in the Related content section on the EIIR start page
