...
--A temporary stored procedure in order to test INSSight Integration
--Stored procedure represents Bankruptcy and IVA data to be provisioned by INSSight Phase 1
--It is not envisaged this procedure is to be deployed past SIT

/****** Object:  StoredProcedure [dbo].[getEiirIndexBIVAonly]    Script Date: 11/7/2024 12:20:55 PM ******/
SET ANSI_NULLS OFF
GO
...
CREATE OR ALTER   PROCEDURE [dbo].[getEiirIndexBIVAonly]
AS
...
INSERT INTO #Cases 
SELECT DISTINCT CaseNo, IndivNo, Type as InsolvencyType FROM eiirSnapshotTABLE WHERE Type IN ('B','I')
