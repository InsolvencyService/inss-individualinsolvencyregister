...
namespace INSS.EIIR.Services
{
    public class ExtractService : IExtractService
    {
        ...
        public ExtractService(
            ...
            IOptions<BlobConfig> blobOptions,
            BlobServiceClient blobServiceClient)
        {
            _logger = loggerFactory.CreateLogger<ExtractService>();
            _blockIDArrayList = new();
            _dbConfig = dbOptions.Value;
            _blobConfig = blobOptions.Value;
            _blobServiceClient = blobServiceClient;
            _containerClient = _blobServiceClient.GetBlobContainerClient(_blobConfig.ContainerName);
        }
